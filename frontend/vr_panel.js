const VrPanel = (function () {
    ...
    async function fetchTimeSeries() {
        try {
            ...
            const resp = await fetch(`${API_URL}/api/v2/vr/time_series`, {
                method: 'POST',
    ...
    async function runSimulation() {
        try {
            ...
            const resp = await fetch(`${API_URL}/api/v2/vr/simulate`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    gauge_height_chi: gauge,
